...
WorldBlueprint buildSeedWorld() {
  final areas = <int, Area>{
    1: const Area(
      id: 1,
      name: 'Corredor',
      backgroundPath: 'areas/area (1).jpg',
      connectionIds: [1, 2],
    ),
    2: const Area(
      id: 2,
      name: 'Sala de Aula',
      backgroundPath: 'areas/area (2).jpg',
      connectionIds: [1, 3],
    ),
    3: const Area(
      id: 3,
      name: 'Cantina',
      backgroundPath: 'areas/area (3).jpg',
      connectionIds: [2, 4],
    ),
    4: const Area(
      id: 4,
      name: 'Pátio',
      backgroundPath: 'areas/area (4).jpg',
      connectionIds: [3, 4],
    ),
  };
  ...
  final characters = <int, Character>{
    1: const Character(
      ...
      name: 'Ana',
      colorHex: '#e91e8c',
      portraitPath: 'portraits/portrait (1).png',
      areaId: 1,
      bodyPath: 'bodies/body (1).png',
    ),
    2: const Character(
      id: 2,
      name: 'Tiago',
      colorHex: '#f44336',
      portraitPath: 'portraits/portrait (2).png',
      areaId: 2,
      bodyPath: 'bodies/body (2).png',
    ),
    3: const Character(
      id: 3,
      name: 'Sofia',
      colorHex: '#2196f3',
      portraitPath: 'portraits/portrait (3).png',
      areaId: 3,
      bodyPath: 'bodies/body (3).png',
    ),
  };
